...
export const PostProvider = ({ children }) => {
  ...
  const fetchUserPosts = async (email) => {
    try {
      const response = await fetch(`https://blog-web-be-a7k7.onrender.com/posts/your-post/${email||userEmail}`, {
        method: 'GET',
  ...
  const fetchAllPosts = async () => {
    try {
      const response = await fetch('https://blog-web-be-a7k7.onrender.com/posts', {
        method: 'GET',
        headers: { 'Content-Type': 'application/json' },
      });
  ...
  const fetchRelatedPosts = async (relatedData) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://blog-web-be-a7k7.onrender.com/posts/related?data=${query}`,
        {
          method: 'GET',
          headers: { 'Content-Type': 'application/json' },
        }
  ...
  const fetchPostById = async (id) => {
    try {
      const response = await fetch(`https://blog-web-be-a7k7.onrender.com/posts/id/${id}`, {
        method: 'GET',
        headers: { 'Content-Type': 'application/json' },
      });
  ...
  const fetchPostSearch = async (searchTerm) => {
    try {
      const response = await fetch(
        `https://blog-web-be-a7k7.onrender.com/posts/search/${searchTerm}`,
        {
          method: 'GET',
          headers: { 'Content-Type': 'application/json' },
        }
  ...
  const fetchUserLikedPosts = async () => {
    try {
      const response = await fetch('https://blog-web-be-a7k7.onrender.com/users/liked-posts', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const updatePost = async (id, postData) => {
    try {
      const response = await fetch(`https://blog-web-be-a7k7.onrender.com/posts/${id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(postData),
      });
