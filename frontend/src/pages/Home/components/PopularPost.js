...
import newsDefault from '../../../public/newsDefault.jpg';
  ...
  return (
    <div className="p-5">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {listPost.map((post) => (
          <Link to={`/posts/${post._id}`} key={post.id} className="rounded-lg border p-4 shadow-md bg-white hover:shadow-lg transition-shadow">
